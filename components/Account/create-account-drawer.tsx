    ...
    <Drawer open={openDrawer} onOpenChange={setOpenDrawer}>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>
            Using the below form you can create a new Account and sync with
            WhyImBroke.
          </DrawerDescription>
        </DrawerHeader>
        <div className="px-5 pb-3">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("type", value as "SAVINGS" | "CHEQUING")
                }
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("currency", value as "CAD" | "USD" | "INR")
                }
