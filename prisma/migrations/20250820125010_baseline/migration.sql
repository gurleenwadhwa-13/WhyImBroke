-- CreateEnum
CREATE TYPE "public"."AccountType" AS ENUM ('SAVINGS', 'CHEQUING');

-- CreateEnum
CREATE TYPE "public"."CurrencyList" AS ENUM ('CAD', 'USD', 'INR');

-- CreateEnum
CREATE TYPE "public"."TransactionType" AS ENUM ('EXPENSE', 'INCOME');

-- CreateEnum
CREATE TYPE "public"."RecurringIntervalList" AS ENUM ('DAILY', 'WEEKLY', 'BIWEEKLY', 'MONTHLY', 'YEARLY', 'NONE');
...
CREATE TABLE "public"."accounts" (
    ...
    "currency" "public"."CurrencyList" NOT NULL,
...
CREATE TABLE "public"."transactions" (
    ...
    "recurringInterval" "public"."RecurringIntervalList",
